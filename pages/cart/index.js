...
Page({
    ...
    totalPrice: function () {
        ...
        for (var i = 0; i < list.length; i++) {
            ...
            totalPrice = totalPrice + (( list[i].singlePrice ).toFixed(2)) * list[i].number
        }
        return totalPrice;
    },
    ...
    deleteSelected: function () {
       ...
       var newCart = []
        cart.forEach(e=>{
           if(goods.indexOf(e.food_id)==-1){
               newCart.push(e);
           }
       })
       app.setStorage("cart",newCart);
    ...
    getCartList: function () {
        ...
        cart.forEach(e=>{
            price =  ((e.singlePrice).toFixed(2)) * e.number 
            e.price = price       
        })
        this.setData({
            list: cart,
